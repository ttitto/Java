...
public class Task08ExtractEmails {
/*Write a program to extract all email addresses from given text. The text comes at
    the first input line. Print the emails in the output, each at a separate line. 
...
*/
    public static void main(String[] args) {
        ...
        Pattern emailPat=Pattern.compile("[\\w]+[_\\.\\-]*[\\w]+@[\\w]+([\\.\\-]{0,1}?[\\w]+)+");
        Matcher mMails=emailPat.matcher(input);
        
        for (int i = 0;mMails.find() ; i++) {
            System.out.println(mMails.group(0));
        }
    }
}
